...
var updateHtml = function () {
  ...
  var html = '<h1>' + 'Hi, my name is ' + firstName + ' ' + lastName + '!' + '</h1>' + '<p>' + description + '</p>' + '<p>' + 'If you\'re interested in a date, you can email me at ' + '<a href="mailto:' + email + '" target="_blank">' + email + '</a>' + ' or give me a call at ' + '<a href="tel:' + phone + ' " target="_blank">' + phone + '</a>' + '</p>' + '.'
  previewParagraph.innerHTML = html
  htmlParagraph.textContent = html
}
